...
public class DepartementInserer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Departement departement = new Departement(request.getParameter("label"));
        try {
            this.departementsDAO.save(departement);
            request.getSession().setAttribute("success","Departement avec la label "+request.getParameter("label")+" a ete ajoute avec success !");;
            response.sendRedirect("/mini_annuaire/Departements");
        } catch (SQLException ex) {
            request.getSession().setAttribute("error","erreur dans l'insertion log: "+ex.getMessage());
            response.sendRedirect("/mini_annuaire/Departements/Insertion");        }
    }
