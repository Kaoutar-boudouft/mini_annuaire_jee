...
public class FilieresByHint extends HttpServlet {
    ...
    FiliereDAO fliereDAO = new FiliereDAO();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
                ArrayList<Filiere> filieres = this.fliereDAO.getFiliereByHint(request.getParameter("hint"),
                        request.getParameter("departement"));
                Gson gson = new Gson();
                String jsonFilieres = gson.toJson(filieres);               
