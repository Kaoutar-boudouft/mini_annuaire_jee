...
<%-- 
    Document   : InsererDepartement
    Created on : May 18, 2023, 4:49:16 PM
    Author     : KAOUTAR
--%>
...
<html>
    <head>
        ...
        <title>Inserer Departement</title>
    </head>
...
<div>
    ...
    <span class="alert-content">
     ...
     <h1 align="center" style="color:white;margin-bottom: 10px;text-transform: uppercase">Inserer departement</h1>
