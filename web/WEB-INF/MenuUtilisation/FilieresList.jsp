...
<%-- 
    Document   : FilieresList
    Created on : May 18, 2023, 4:17:01 PM
    Author     : KAOUTAR
--%>
    ...
    <div class="container d-flex align-items-center">
      ...
      <!-- <a href="index.html" class="logo me-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
       ...
       <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="" href="Filieres/Insertion">Ajouter</a></li>
        </ul>
...
<div>
    ...
    <select id="departement" style="width:200px;padding: 8px">
          ...
          <div  class="item col-lg-6 col-md-6 d-flex align-items-stretch">
            <div class="member w-100">
              <div class="w-100 member-content p-4">
                <h4 >Filiere :${filiere.label}</h4>
                <p>Departement : ${filiere.departement.label}</p>
              </div>
            </div>
          </div>
         </c:forEach>
  ...
  <script>
            ...
            input.keyup(function(){
                $.ajax({
                    type:"GET",
                    url:"/mini_annuaire/FilieresByHint?hint="+input.val()+"&&departement="+select.val(),
                    dataType:'json'
                    ...
                    for(var i in result){
                        ...
                        item.innerHTML = '<div class="member w-100"><div class="w-100 member-content p-4"><h4 >Filiere : '+result[i].label+'</h4><p>Departement : '+result[i].departement.label+'</p></div></div>';
